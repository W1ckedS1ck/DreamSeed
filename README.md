...
- **CI/CD** — 9 parallel GitHub Actions jobs: ShellCheck, ruff, ansible-lint, tflint, Trivy, gitleaks, terraform validate, OpenTofu validate, pre-commit hooks. Plus deploy, backup-test, drift-detection, rollback workflows
...
CI checks: ShellCheck · ruff · ansible-lint · tflint · **Trivy** · **gitleaks** · terraform validate · **OpenTofu validate** · **pre-commit hooks**. Dependencies: **Renovate** (auto-PRs). Costs: **Infracost App** (PR comments).
