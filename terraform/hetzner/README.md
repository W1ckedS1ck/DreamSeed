...
| <a name="input_environment"></a> [environment](#input\_environment) | Deployment environment (dev-hetz, test, prod-hetz) — used in resource names to avoid conflicts | `string` | n/a | yes |
